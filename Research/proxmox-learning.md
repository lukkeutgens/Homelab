...
- Adding a users in a Realm will not add users directly to that Realm itself, it will only create that user in Proxmox. You will have to create the user also in that realm itself. So when yoy add a Linux PAM user, you will have to create that user also on the Linux system itself.
